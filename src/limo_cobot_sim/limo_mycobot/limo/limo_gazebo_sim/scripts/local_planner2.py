...
class DWAPlanner:
    ...
    def __init__(self):
        ...
        # Subscribers
        self.path_sub = rospy.Subscriber('/robot2/global_path', Path, self.path_callback)
        ...
        self.local_path_pub = rospy.Publisher('/robot2/local_path', Path, queue_size=10)
        self.goal_reached_pub = rospy.Publisher('/robot2/goal_reached', Bool, queue_size=10)
        self.goal_failed_pub = rospy.Publisher('/robot2/goal_failed', Bool, queue_size=10)
    ...
    def get_closest_path_point(self):
        ...
        try:
            ...
            for pose in self.global_path.poses:
                ...
                try:
                    p_base = self.tf_buffer.transform(p_current, 'robot2_base_link', 
                                                     rospy.Duration(0.1))
                except:
                    continue
    ...
    def distance_to_goal(self):
        ...
        try:
            ...
            goal_base = self.tf_buffer.transform(goal_current, 'robot2_base_link',
                                                rospy.Duration(0.1))
    ...
    def control_loop(self, event):
        ...
        rospy.loginfo_throttle(1.0, 
            f"robot2 v={v:.2f} w={w:.2f} | dist={dist_to_goal:.2f}m | t={pursuit_time:.0f}s")
    ...
    def publish_local_path(self, trajectory):
        ...
        path_msg.header.frame_id = "robot2_base_link"
