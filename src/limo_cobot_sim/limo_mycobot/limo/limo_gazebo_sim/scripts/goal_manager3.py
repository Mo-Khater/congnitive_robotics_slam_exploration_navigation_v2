...
class GoalManager:
    ...
    def __init__(self):
        ...
        # Subscribers
        self.goal_sub = rospy.Subscriber('/robot3/goal', PoseStamped, self.goal_callback)
        ...
        self.active_goal_pub = rospy.Publisher('/robot3/active_goal', PoseStamped, queue_size=10)
