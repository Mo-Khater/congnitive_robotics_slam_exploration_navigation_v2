...
class AStarPlanner:
    def __init__(self):
        ...
        self.pose_sub = rospy.Subscriber('/robot3/robot_pose', PoseStamped, self.pose_callback)
        
        # Publishers
        self.path_pub = rospy.Publisher('/robot3/global_path', Path, queue_size=10)
    ...
    def plan_path(self):
        ...
        path_msg.header.frame_id = "robot3_map"
