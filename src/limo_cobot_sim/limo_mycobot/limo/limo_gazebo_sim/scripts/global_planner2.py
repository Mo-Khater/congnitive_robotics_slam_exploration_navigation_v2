...
class AStarPlanner:
    def __init__(self):
        ...
        self.pose_sub = rospy.Subscriber('/robot2/robot_pose', PoseStamped, self.pose_callback)
        
        # Publishers
        self.path_pub = rospy.Publisher('/robot2/global_path', Path, queue_size=10)
    ...
    def plan_path(self):
        ...
        path_msg.header.frame_id = "robot2_map"
