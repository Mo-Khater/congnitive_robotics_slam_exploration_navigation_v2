...
class GoalManager:
    ...
    def __init__(self):
        ...
        # Subscribers
        self.goal_sub = rospy.Subscriber('/robot2/goal', PoseStamped, self.goal_callback)
        ...
        self.active_goal_pub = rospy.Publisher('/robot2/active_goal', PoseStamped, queue_size=10)
